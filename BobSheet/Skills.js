...
function SkillsA() {
  document.getElementById("category").innerHTML = "Shuriken"
  if (skillab1 == 1) {
    document.getElementById("begin1").innerHTML = "<span class=white><span class=bigboi>Zoom Shuriken:</span> Throw a shuriken with more speed. <span class=equipbuff>(Speed * 1.5)</span> <span class=mana>3 MP</span> <span class=sklvl>1/3</span> <span class=skpts>0/<span id=b1spend>8</span></span><span> &nbsp; <button class=upgrade id=yesb1>Upgrade!</button>"
  }
  if (skillab2 == 0) {
    document.getElementById("begin2").innerHTML = "<span class=lock><span class=bigboi>Boomerang Shuriken:</span> The shuriken boomerangs between you <br>and a bit past a target <span class=lockequipbuff>1 </span> time. <span class=lockmana>4 MP</span> <span class=locksklvl>0/3</span> <span class=lockskpts>0/<span id=b2spend>5</span></span></span> &nbsp; <button class=unlock id=yesb2>Unlock!</button> "
  }
  if (skillab3 == 0) {
    document.getElementById("begin3").innerHTML = "<span class=lock><span class=bigboi>Trick Shot:</span> Throw a shuriken into the air for increased power. <span class=lockequipbuff>(Accuracy 5%)</span> (Atk*2). <span class=lockmana> 5 MP</span><span class=locksklvl> 0/3 </span> <span class=lockskpts> 0/<span id=b3spend>5</span> </span></span> &nbsp; <button class=unlock id=yesb3>Unlock!</button>"
  }
  if (skillab4 == 0) {
  ...
  if (skillab2 == 1) {
    document.getElementById("begin2").innerHTML = "<span class=white><span class=bigboi>Boomerang Shuriken:</span> The shuriken boomerangs between you <br>and a bit past a target <span class=equipbuff>1 </span> time. <span class=mana>4 MP</span> <span class=sklvl>1/3</span> <span class=skpts>0/<span id=b2spend>8</span></span></span> <button class=upgrade id=yesb2>Upgrade!</button> "
  }
  if (skillab3 == 1) {
    document.getElementById("begin3").innerHTML = "<span class=white><span class=bigboi>Trick Shot:</span> Throw a shuriken into the air for increased power. <span class=equipbuff>(Accuracy 5%)</span> (Atk*2). <span class=mana> 5 MP</span><span class=sklvl> 1/3 </span> <span class=skpts> 0/<span id=b3spend>8</span> </span></span> <button class=upgrade id=yesb3>Upgrade!</button>"
  }
  if (skillab4 == 1) {
  ...
  if (skillab1 == 2) {
    document.getElementById("begin1").innerHTML = "<span class=white><span class=bigboi>Zoom Shuriken:</span> Throw a shuriken with more speed. <span class=equipbuff>(Speed * 2)</span> <span class=mana>3 MP</span> <span class=sklvl>2/3</span> <span class=skpts>0/<span id=b1spend>12</span></span><span> &nbsp; <button class=upgrade id=yesb1>Upgrade!</button>"
  }
  if (skillab2 == 2) {
    document.getElementById("begin2").innerHTML = "<span class=white><span class=bigboi>Boomerang Shuriken:</span> The shuriken boomerangs between you <br>and a bit past a target <span class=equipbuff>2 </span> time. <span class=mana>4 MP</span> <span class=sklvl>2/3</span> <span class=skpts>0/<span id=b2spend>12</span></span></span> <button class=upgrade id=yesb2>Upgrade!</button> "
  }
  if (skillab3 == 2) {
    document.getElementById("begin3").innerHTML = "<span class=white><span class=bigboi>Trick Shot:</span> Throw a shuriken into the air for increased power. <span class=equipbuff>(Accuracy 10%)</span> (Atk*2). <span class=mana> 5 MP</span><span class=sklvl> 2/3 </span> <span class=skpts> 0/<span id=b3spend>12</span> </span></span> <button class=upgrade id=yesb3>Upgrade!</button>"
  }
  if (skillab4 == 2) {
  ...
  if (skillab1 == 3) {
    document.getElementById("begin1").innerHTML = "<span class=white><span class=bigboi>Zoom Shuriken:</span> Throw a shuriken with more speed. <span class=equipbuff>(Speed * 2.5)</span> <span class=mana>3 MP</span> <span class=sklvl>3/3</span> <span class=skpts>---</span><span> &nbsp;"
  }
  if (skillab2 == 3) {
    document.getElementById("begin2").innerHTML = "<span class=white><span class=bigboi>Boomerang Shuriken:</span> The shuriken boomerangs between you <br>and a bit past a target <span class=equipbuff>3 </span> time. <span class=mana>4 MP</span> <span class=sklvl>3/3</span> <span class=skpts>---</span></span> "
  }
  if (skillab3 == 3) {
    document.getElementById("begin3").innerHTML = "<span class=white><span class=bigboi>Trick Shot:</span> Throw a shuriken into the air for increased power. <span class=equipbuff>(Accuracy 15%)</span> (Atk*2). <span class=mana> 5 MP</span><span class=sklvl> 3/3 </span> <span class=skpts> --- </span></span>"
  }
  if (skillab4 == 3) {
    document.getElementById("begin4").innerHTML = "<span class=white><span class=bigboi>Keen Eye:</span> Identifies and strikes a target's weak point. <span class=equipbuff>(Effect to be determined++) </span><span class=mana>3 MP </span> <span class=sklvl> 3/3 </span> <span class=skpts> --- </span> </span>"
  }
...
function SkillsC() {
   document.getElementById("category").innerHTML = "Electric Magic (Shuriken)"
  if (skillcb1 == 1) {
    document.getElementById("begin1").innerHTML = "<span class=white><span class=bigboi>Spark:</span> <span class=equipbuff> 10% </span> chance to stun on hit. <span class=mana> (Passive) </span> <span class=sklvl> 1/3 </span> <span class=skpts> 0/<span id=pricec1>8</span> &nbsp; <button class=upgrade id=mhmb1>Upgrade!</button>"
  }
  if (skillcb2 == 0) {
    document.getElementById("begin2").innerHTML = "<span class=lock><span class=bigboi> Lightning Toss: </span>Throws a shuriken of thunder . <span class=lockequipbuff>(Atk + Speed/3)</span> <span class=lockmana> 5 MP </span> <span class=locksklvl> 0/3 </span> <span class=lockskpts> 0/<span id=pricec2>5</span> </span> &nbsp; <button class=unlock id=mhmb2>Unlock!</button> "
  }
  if (skillcb3 == 0) {
    document.getElementById("begin3").innerHTML = "<span class=lock><span class=bigboi> Thunder Drop:</span> A shocking strike with added knockback. <br> <span class=lockequipbuff>10</span> metres of knockback.   <span class=lockmana> 5 MP </span> <span class=locksklvl> 0/3 </span> <span class=lockskpts> 0/<span id=pricec3>5</span> &nbsp; <button class=unlock id=mhmb3>Unlock!</button>"
  }
  if (skillcb4 == 0) {
    document.getElementById("begin4").innerHTML = "<span class=lock><span class=bigboi> Thunder Cloud: </span> A large thundercloud covers the battlefield, <br> lowering the resistance of anyone within it by <span class=lockequipbuff>10</span>. <span class=lockmana> 2 MP </span> <span class=locksklvl> 0/3 </span> <span class=lockskpts> 0/<span id=pricec4>5</span> &nbsp; <button class=unlock id=mhmb4>Unlock!</button>"
  }
  if (skillcb2 == 1) {
    document.getElementById("begin2").innerHTML = "<span class=white><span class=bigboi> Lightning Toss: </span>Throws a shuriken of thunder . <span class=equipbuff>(Atk + Speed/3)</span> <span class=mana> 5 MP </span> <span class=sklvl> 1/3 </span> <span class=skpts> 0/<span id=pricec2>8</span> </span> &nbsp; <button class=upgrade id=mhmb2>Upgrade!</button> "
  }
  if (skillcb3 == 1) {
    document.getElementById("begin3").innerHTML = "<span class=white><span class=bigboi> Thunder Drop:</span> A shocking strike with added knockback. <br> <span class=equipbuff>10</span> metres of knockback.   <span class=mana> 5 MP </span> <span class=sklvl> 1/3 </span> <span class=skpts> 0/<span id=pricec3>8</span> &nbsp; <button class=upgrade id=mhmb3>Upgrade!</button>"
  }
  if (skillcb4 == 1) {
    document.getElementById("begin4").innerHTML = "<span class=white><span class=bigboi> Thunder Cloud: </span> A large thundercloud covers the battlefield, <br> lowering the resistance of anyone within it by <span class=equipbuff>10</span>. <span class=mana> 2 MP </span> <span class=sklvl> 1/3 </span> <span class=skpts> 0/<span id=pricec4>8</span> &nbsp; <button class=upgrade id=mhmb4>Upgrade!</button>"
  }
  if (skillcb1 == 2) {
    document.getElementById("begin1").innerHTML = "<span class=white><span class=bigboi>Spark:</span> <span class=equipbuff> 20% </span> chance to stun on hit. <span class=mana> (Passive) </span> <span class=sklvl> 2/3 </span> <span class=skpts> 0/<span id=pricec1>12</span> &nbsp; <button class=upgrade id=mhmb1>Upgrade!</button>"
  }
  if (skillcb2 == 2) {
    document.getElementById("begin2").innerHTML = "<span class=white><span class=bigboi>Lightning Toss: </span>Throws a shuriken of thunder . <span class=equipbuff>(Atk + Speed*2/3)</span> <span class=mana> 5 MP </span> <span class=sklvl> 2/3 </span> <span class=skpts> 0/<span id=pricec2>12</span> </span> &nbsp; <button class=upgrade id=mhmb2>Upgrade!</button> "
  }
  if (skillcb3 == 2) {
    document.getElementById("begin3").innerHTML = "<span class=white><span class=bigboi> Thunder Drop:</span> A shocking strike with added knockback. <br> <span class=equipbuff>15</span> metres of knockback.   <span class=mana> 5 MP </span> <span class=sklvl> 2/3 </span> <span class=skpts> 0/<span id=pricec3>12</span> &nbsp; <button class=upgrade id=mhmb3>Upgrade!</button>"
  }
  if (skillcb4 == 2) {
    document.getElementById("begin4").innerHTML = "<span class=white><span class=bigboi> Thunder Cloud: </span> A large thundercloud covers the battlefield, <br> lowering the resistance of anyone within it by <span class=equipbuff>15</span>. <span class=mana> 2 MP </span> <span class=sklvl> 2/3 </span> <span class=skpts> 0/<span id=pricec4>12</span> &nbsp; <button class=upgrade id=mhmb4>Upgrade!</button>"
  }
  if (skillcb1 == 3) {
    document.getElementById("begin1").innerHTML = "<span class=white><span class=bigboi>Spark:</span> <span class=equipbuff> 35% </span> chance to stun on hit. <span class=mana> (Passive) </span> <span class=sklvl> 3/3 </span> <span class=skpts>---</span> &nbsp; "
  }
  if (skillcb2 == 3) {
    document.getElementById("begin2").innerHTML = "<span class=white><span class=bigboi>Lightning Toss: </span>Throws a shuriken of thunder . <span class=equipbuff>(Atk + Speed)</span> <span class=mana> 9 MP </span> <span class=sklvl> 3/3 </span> <span class=skpts>---</span> &nbsp; "
  }
  if (skillcb3 == 3) {
    document.getElementById("begin3").innerHTML = "<span class=white><span class=bigboi> Thunder Drop:</span> A shocking strike with added knockback. <br> <span class=equipbuff>25</span> metres of knockback.   <span class=mana> 8 MP </span> <span class=sklvl> 3/3 </span> <span class=skpts>---</span> &nbsp;"
  }
  if (skillcb4 == 3) {
    document.getElementById("begin4").innerHTML = "<span class=white><span class=bigboi> Thunder Cloud: </span> A large thundercloud covers the battlefield, <br> lowering the resistance of anyone within it by <span class=equipbuff>25</span>. <span class=mana> 4 MP </span> <span class=sklvl>3/3 </span> <span class=skpts>---</span> &nbsp; "
  }
